...
const OnlinePharmacyForm = () => {
  ...
  return (
    <div className="bg-white text-black rounded-lg p-10 md:px-8 md:py-7">
      ...
      <div className="flex flex-col md:flex-row justify-between space-y-8 md:space-y-0">
        ...
        <div className="flex items-end">
          <div
            ...
            className="flex justify-end items-center bg-deepBlue-100 rounded-lg md:h-0 text-white px-8 py-2 md:px-3 md:py-6"
          >
            Chat with a pharmacist
          </div>
        </div>

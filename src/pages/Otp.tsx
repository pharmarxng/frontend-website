        ...
        <div className="w-[343px] md:w-[666px] h-[270px] m-auto center">
          ...
          <div>
            ...
            <div className='mt-[42px] flex'>
              <div className="text-primary-200 text-[16px] md:text-[20px]">An OTP will be sent to your mail</div>
            </div>
          ...
          <div>
            <div className="bg-secondary-300 rounded-[10px] h-[48px] md:h-[74px] w-full  mt-[32px] text-center flex">
              <div className="w-full h-[29px] font-semibold text-[18px] md:text-2xl text-white m-auto"><Link to="/Reset">SUBMIT
              </Link>
              </div></div>
          </div>
        </div>

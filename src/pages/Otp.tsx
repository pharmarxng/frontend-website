...
const Login = () => {
  return (
    <div className="bg-white min-h-screen font-normal text-primary-200 h-full">
      <Navbar />
      <div className="flex items-center bg-white h-[330px] md:h-[477px] py-[30px] md:py-[88px]">
        <div className="w-[343px] md:w-[666px] h-[270px] m-auto center">
          <div className=" text-[18px] md:text-3xl">Reset Password</div>
          ...
          <div>
            ...
            <div className="mt-[42px] flex">
              <div className="text-primary-200 text-[16px] md:text-[20px]">
                An OTP will be sent to your mail
              </div>
            </div>
          </div>

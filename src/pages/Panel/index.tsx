        ...
        <PageWrapper>
            <div className="flex-1 min-h-screen p-6 lg:p-12">
                <header className="flex flex-row justify-between mb-7 items-center">
                    ...
                    <button className="capitalize bg-white br-2 text-black font-bold p-4 text-base rounded-xl">+ Add new user</button>
                </header>

                <table className="bg-white w-full rounded-2xl">
                    <thead>
                        <tr className="h-16 border-solid border-b bg-[#f7f7f9] rounded-2xl">
                            {
